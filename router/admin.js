...
const { RegisterAdminValidation , LoginAdminValidation ,Adminvalidation } = require('../middlewares/Validationadmin')
const { RegisterAdmin , LoginAdmin , getOneAdmin , updateAdmin , deleteAdmin , addService , updateService , deleteService , getAllService , addCategory  , updateCategory  , deleteCategory , getCategory, getReclamation, updateReclamation, deleteReclamation, VerifyUser, deleteUserByAdmin, getAllUserRole, getAllAgentService, getAllAgentCategory } = require('../controllers/admin.controllers')
...
// Register Admin
router.post('/register', isAuthAdmin ,RegisterAdminValidation(), Adminvalidation , RegisterAdmin )
