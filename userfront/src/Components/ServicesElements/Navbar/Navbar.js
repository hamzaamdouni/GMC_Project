...
dispatch(logout())
    ...
    return (
        <div>
        { isload ? (<h3> stana</h3>) : user ? (
            <nav className='navbarContainer'>
            <img src ={Logo} alt='logo' className='NavImg'/>
            <div className='ProfileContent'>
                <img src="https://images.unsplash.com/photo-1565464027194-7957a2295fb7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80" alt='' className="profileNavbar" />
                <div class="dropdown">
                    <button class="dropbtn"><BiCaretDown/></button>
